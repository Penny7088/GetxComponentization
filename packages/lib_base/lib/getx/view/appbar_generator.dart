...
class AppBarGenerator {
  ...
  static configAppBarBackBtnWidget({
    ...
    ThemeData themeData = Theme.of(context);
    leadingIconColor ??=
        (themeData.appBarTheme.iconTheme?.color ?? Colors.black);

    Widget backBtn =
        leading ??
        IconButton(
          icon: Icon(icon ?? Icons.arrow_back_ios, color: leadingIconColor),
    ...
    return AppBar(
      ...
      leading:
          ...
          (showBack && canShowBack
              ...
              : null),
      title: titleView ?? Text(title, style: textStyle),
      elevation: elevation,
